...
export function useBlurContainerRef(): RefObject<
  HTMLDivElement | null
> {
  ...
  if (!ctx) {
    throw new Error(
      "useBlurContainerRef must be used within BlurScrollRoot"
    );
  }
...
/**
 * Global blur layers + context for BlurSection
 * scroll triggers.
 */
export default function BlurScrollRoot({
  children,
}: {
  children: ReactNode;
}) {
