                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/dribbble.svg" width="200" height="56" loading="lazy" /> */}
                            </div>
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/logitech.svg" width="200" height="60" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/envato.svg" width="700" height="169" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/crewai.svg" width="200" height="53" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/deepseek.svg" width="665" height="148" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/mozilla.svg" width="200" height="48" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/udemy.svg" width="200" height="75" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/angular.svg" width="200" height="49" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <img alt="Azurio Template Image Example"    src="/img/brands/ghostgaming.svg" width="200" height="84" loading="lazy" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Aliquam suscipit eros sed turpis tristique
