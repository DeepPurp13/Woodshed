//#region node_modules/ukiyojs/dist/ukiyo.esm.min.js
var t = function(t) {
	return Array.prototype.slice.call(t);
}, e = function() {
	var t = window.navigator.userAgent, e = !!t.match(/iPad/i) || !!t.match(/iPhone/i), i = !!t.match(/WebKit/i);
...
n.prototype.createParallax = function() {
	...
	var t = this.element.getAttribute("data-u-scale"), e = this.element.getAttribute("data-u-speed"), i = this.element.getAttribute("data-u-willchange");
	...
	var e = this.element.closest("picture"), i = null !== e ? e : this.element, n = i.parentNode;
	...
	var t = this.element.style, e = "transform";
	...
	t < 0 && (t = 0);
	var e = this.wrapper.getBoundingClientRect().top + t, i = (t + this.vh - e) / ((this.vh + this.wrapperHeight) / 100), n = Math.min(100, Math.max(0, i)) / 100, r = this.overflow, o = this.options.speed, a = (r * o - r) / 2, s = r * (1 - n) * o * this.damp - a;
	return Number(s.toFixed(4));
}, n.prototype.calcDamp = function(t) {
	var e = this.options.scale, i = this.options.speed;
	if (!(i >= 1.4 || e >= 1.4) || !(t <= 1e3)) return 1;
	e < 1 && (e = 1), i < 1 && (i = 1);
	var n = 1.2 - (1 - (t / 1e3 + (3 - (e + i))));
	return Math.floor(100 * Math.max(.5, Math.min(1, n))) / 100;
	...
	var t = this.wrapper.style, e = this.element.style;
...
var r = function(e, i) {
	...
	var n, r;
	this.instances = [], this.externalRAF = i && i.externalRAF || !1, this.onResizeEvent = this.resize.bind(this), n = "undefined" != typeof Promise && -1 !== Promise.toString().indexOf("[native code]"), r = "undefined" != typeof Element && Element.prototype.closest, n && r && "IntersectionObserver" in window && this.init(function(e) {
