 ...
 * The key is public (inlined at build) — set `VITE_WEB3FORMS_ACCESS_KEY` in `.env` (not hardcoded).
 */
export default function ContactForm() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (!key) {
      setStatus("error");
      setFeedback(
        "Set VITE_WEB3FORMS_ACCESS_KEY in .env (get a key at web3forms.com), then restart the dev server.",
      );
      return;
    }
